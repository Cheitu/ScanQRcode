...
import com.aronj.scanqrcode.MainActivity;
import com.aronj.scanqrcode.R;
...
//		scanResult = (TextView) findViewById(R.id.capture_scan_result);
		btn_back=(ImageView)findViewById(R.id.capture_scan_btn_back);
	...
	private void addEvents() {
		...
		btn_back.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				Intent intent=new Intent(ScanCaptureAct.this,MainActivity.class);
				startActivity(intent);
				
			}
		});
		
		btn_back.setOnTouchListener(new ImageButton.OnTouchListener(){
			@Override
			public boolean onTouch(View v, MotionEvent event) {
				if(event.getAction() == MotionEvent.ACTION_DOWN){   
					v.setBackgroundResource(R.drawable.scan_back_an);   

				}   
				else if(event.getAction() == MotionEvent.ACTION_UP){   
					v.setBackgroundResource(R.drawable.scan_back_an1); 
